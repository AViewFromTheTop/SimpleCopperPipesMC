...
public class SaveableGameEvent {
    ...
    public static final Codec<SaveableGameEvent> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
            ...
            //BlockState.CODEC.fieldOf("blockState").forGetter(SaveableGameEvent::getBlockState)
    ...
    public static Optional<SaveableGameEvent> readNbt(NbtCompound nbt) {
